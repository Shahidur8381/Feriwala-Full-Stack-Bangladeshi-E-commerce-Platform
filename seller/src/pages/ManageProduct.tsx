...
const ManageProduct: React.FC = () => {
  ...
  const fetchSellerProfile = async () => {
    try {
      ...
      const res = await axios.get(`${import.meta.env.VITE_API_URL}/api/sellers/profile`, {
  ...
  const handleFormSubmit = async (formData: FormData) => {
    try {
      ...
      formData.append("shopname", sellerProfile.shopName || sellerProfile.shopname || "");
      formData.append("shopdetails", sellerProfile.shopDetails || sellerProfile.shopdetails || "");
